...
typedef struct {
	S3C24X0_REG32	DISRC;
#ifdef CONFIG_S3C2410 || CONFIG_S3C2440
...
} /*__attribute__((__packed__))*/ S3C2440_CAMERA;
...
typedef struct {
	...
	S3C24X0_REG8	res9[7];
	S3C24X0_REG8	MAXP_REG;
#if defined CONFIG_S3C2400 || CONFIG_S3C2410
	S3C24X0_REG8	res10[7];
...
#endif
#ifdef CONFIG_S3C2440         /* add by volatile xian*/
	S3C24X0_REG32	GPACON;
	S3C24X0_REG32	GPADAT;
	S3C24X0_REG32	res1[2];  /* not use */
	S3C24X0_REG32	GPBCON;
	S3C24X0_REG32	GPBDAT;
	S3C24X0_REG32	GPBUP;
	S3C24X0_REG32	res2;
